...
Public Class clsModuleIMS
    ...
    Public Function generateRegConfirmFile() As String
        ...
        str = str & (("</td></tr></table>")) & vbCrLf
        str = str & (("<" & "%else")) & vbCrLf        str = str & (vbIndent & ("insertData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ")")) & vbCrLf
    ...
    Public Function generateMemEditFile() As String
        ...
        str = str & vbCrLf & (vbIndent & vbIndent & "call updateData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)")
        If Me.IMSType = 2 Then
            str = str & vbCrLf & (vbIndent & vbIndent & "call DisApproveData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)")
        End If
    ...
    Public Function generateMemConfirmFile() As String
        ...
        str = str & vbCrLf & (("call retrieveData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)"))
        str = str & vbCrLf & vbCrLf
        ...
        str = str & vbCrLf & (vbIndent & "call approveData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.memListFile & Chr(34))
        ...
        str = str & vbCrLf & (vbIndent & "call disapproveData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.memListFile & Chr(34))
        ...
        str = str & vbCrLf & (vbIndent & "call deleteData(" & Chr(34) & Me.DataBaseTable1Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.memListFile & Chr(34))
    ...
    Public Function generateIncFuncFile() As String
        ...
        str = str & ("Sub insertData(tableName)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql, rs") & vbCrLf
        str = str & vbCrLf

        str = str & (vbIndent & "sql = " & Chr(34) & "INSERT INTO " & Chr(34) & " & tableName & " & Chr(34) & " (" & Chr(34) & vbCrLf)

        If Me.IMSType = 2 Then
            str = str & vbIndent & "if tableName = " & Chr(34) & Me.DataBaseTable2Name & Chr(34) & " then" & vbCrLf
            str = str & vbIndent & vbIndent & "sql = sql & " & Chr(34) & "regID, " & Chr(34) & vbCrLf
            str = str & vbIndent & "end if" & vbCrLf
        End If
        ...
        If Me.IMSType = 2 Then
            str = str & vbIndent & "if tableName = " & Chr(34) & Me.DataBaseTable2Name & Chr(34) & " then" & vbCrLf
            str = str & vbIndent & vbIndent & "sql = sql & cint(cstr(request(" & Chr(34) & "ID" & Chr(34) & "))) & " & Chr(34) & ", " & Chr(34) & vbCrLf
            str = str & vbIndent & "end if" & vbCrLf
        End If
        If Me.IMSType = 1 Or Me.IMSType = 2 Then
            str = str & vbCrLf
        ...
        str = str & ("sub updateData(tableName, id)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql" & vbCrLf)
        str = str & vbCrLf

        str = str & (vbIndent & "sql = " & Chr(34) & "UPDATE " & Chr(34) & " & tableName & " & Chr(34) & " SET " & Chr(34) & vbCrLf)
        For i = 0 To UBound(dbArray) - 1
        ...
        str = str & ("sub deleteData(tableName, id)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql" & vbCrLf)

        str = str & (vbIndent & "sql = " & Chr(34) & "DELETE FROM " & Chr(34) & " & tableName & " & Chr(34) & " WHERE ID = " & Chr(34) & " & id" & vbCrLf)
        str = str & vbCrLf
        ...
        str = str & ("sub retrieveData(tableName, id)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql, sr, count" & vbCrLf)

        str = str & (vbIndent & "sql = " & Chr(34) & "SELECT * FROM " & Chr(34) & " & tableName & " & Chr(34) & " WHERE ID = " & Chr(34) & " & id" & vbCrLf)
        str = str & vbCrLf
        str = str & (vbIndent & "set db = dbConnect()" & vbCrLf)
        ...
        str = str & ("sub approveData(tableName, id)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql" & vbCrLf)

        str = str & (vbIndent & "sql = " & Chr(34) & "UPDATE " & Chr(34) & " & tableName & " & Chr(34) & " SET approval = 1 WHERE ID = " & Chr(34) & " & id" & vbCrLf)
        ...
        If Me.IMSType = 2 Then
            str = str & vbCrLf
            str = str & vbIndent & "If tableName = " & Chr(34) & Me.DataBaseTable1Name & Chr(34) & " Then" & vbCrLf
            str = str & vbIndent & vbIndent & "Call copyDataToFinal(id)" & vbCrLf
            str = str & vbIndent & "End If" & vbCrLf
            str = str & vbCrLf
        End If
        ...
        str = str & ("sub disApproveData(tableName, id)" & vbCrLf)
        str = str & (vbIndent & "Dim db, sql" & vbCrLf)

        str = str & (vbIndent & "sql = " & Chr(34) & "UPDATE " & Chr(34) & " & tableName & " & Chr(34) & " SET approval = 0 WHERE ID = " & Chr(34) & " & id" & vbCrLf)
        ...
        If Me.IMSType = 2 Then
            '''''''''''''''''''''''''''''''''''''''''''''
            ' Create function copyDataToFinal
            '''''''''''''''''''''''''''''''''''''''''''''
            ...
            str = str & vbCrLf
            str = str & "    sql = " & Chr(34) & "SELECT * FROM " & Me.DataBaseTable2Name & " WHERE regID = " & Chr(34) & " & regID "
            str = str & vbCrLf
            str = str & "    set db = dbConnect()" & vbCrLf
            str = str & "    set rs = dbExecuteRS(db, sql)" & vbCrLf
            str = str & vbCrLf
            ...
            str = str & "    else" & vbCrLf
            str = str & "        call updateFinalDataByRegID(regID)" & vbCrLf
            str = str & "    end if" & vbCrLf
            str = str & vbCrLf
            str = str & "    call dbRSClose(db, rs)" & vbCrLf
            str = str & "end sub" & vbCrLf
            ...
            '''''''''''''''''''''''''''''''''''''''''''''
            ' Create function updateFinalDataByRegID()
            '''''''''''''''''''''''''''''''''''''''''''''
            str = str & writeFunctionComment("Update data in database table " & DataBaseTable1Name & ".")
            str = str & ("sub updateFinalDataByRegID(regID)" & vbCrLf)
            str = str & (vbIndent & "Dim db, sql" & vbCrLf)
            str = str & vbCrLf
            str = str & (vbIndent & "sql = " & Chr(34) & "UPDATE " & Me.DataBaseTable2Name & " SET " & Chr(34) & vbCrLf)
            For i = 0 To UBound(dbArray) - 1
                str = str & (vbIndent & "sql = sql & " & Chr(34) & dbArray(i) & " = " & Chr(34) & " & sqlEncode(session(" & Chr(34) & sessionArray(i) & Chr(34) & ")) & " & Chr(34) & ", " & Chr(34) & vbCrLf)
            Next
            str = str & (vbIndent & "sql = sql & " & Chr(34) & dbArray(i) & " = " & Chr(34) & " & sqlEncode(session(" & Chr(34) & sessionArray(i) & Chr(34) & "))" & vbCrLf)
            str = str & (vbIndent & "sql = sql & " & Chr(34) & " WHERE regID = " & Chr(34) & " & regID " & vbCrLf)

            str = str & vbCrLf
            str = str & (vbIndent & "set db = dbConnect()" & vbCrLf)
            str = str & (vbIndent & "call dbExecute(db, sql)" & vbCrLf)
            str = str & vbCrLf
            str = str & (vbIndent & "call dbClose(db)" & vbCrLf)
            str = str & ("end sub") & vbCrLf
            str = str & vbCrLf & vbCrLf
            ...
            str = str & (vbIndent & "if rs.recordcount > 0 then") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<H3>List of Pending Final Registrations</H3>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<table width=600 border=1>" & Chr(34)) & vbCrLf
            ...
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<tr><td width=150><b>Register Date</b></td><td width=150><b>Name</b></td><td><b>Detail Information</b></td></tr>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & "do while not rs.eof") & vbCrLf
            str = str & (vbIndent & vbIndent & vbIndent & "Response.Write " & Chr(34) & "<tr><td>" & Chr(34) & " & rs(" & Chr(34) & "regDate" & Chr(34) & ") & " & Chr(34) & "</td><td>Dummy Field</td><td><a href=" & Chr(39) & Me.admFinalConfirmFile & "?src=pending&id=" & Chr(34) & " & rs(" & Chr(34) & "ID" & Chr(34) & ") & " & Chr(34) & "" & Chr(39) & ">Detail</a></td></tr>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & vbIndent & "rs.MoveNext()") & vbCrLf
            str = str & (vbIndent & vbIndent & "loop") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "</table>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & "else") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<h3>Currently there is no pending Final Registration.</h3>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & "end if") & vbCrLf
            ...
            str = str & (vbIndent & "if rs.recordcount > 0 then") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<H3>List of Approved Final Registrations</H3>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<table width=600 border=1>" & Chr(34)) & vbCrLf
            ...
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<tr><td width=150><b>Register Date</b></td><td width=150><b>Name</b></td><td><b>Detail Information</b></td></tr>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & "do while not rs.eof") & vbCrLf
            str = str & (vbIndent & vbIndent & vbIndent & "Response.Write " & Chr(34) & "<tr><td>" & Chr(34) & " & rs(" & Chr(34) & "regDate" & Chr(34) & ") & " & Chr(34) & "</td><td>Dummy Field</td><td><a href=" & Chr(39) & Me.admFinalConfirmFile & "?src=approved&id=" & Chr(34) & " & rs(" & Chr(34) & "ID" & Chr(34) & ") & " & Chr(34) & "" & Chr(39) & ">Detail</a></td></tr>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & vbIndent & vbIndent & "rs.MoveNext()") & vbCrLf
            str = str & (vbIndent & vbIndent & "loop") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "</table>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & "else") & vbCrLf
            str = str & (vbIndent & vbIndent & "Response.Write " & Chr(34) & "<h3>Currently there is no Approved Final Registration.</h3>" & Chr(34)) & vbCrLf
            str = str & (vbIndent & "end if") & vbCrLf
    ...
    Public Function generateAdmEditFinalFile() As String
        ...
        str = str & vbCrLf & (vbIndent & "err = checkError()")
        str = str & vbCrLf & (vbIndent & "if err = " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & (vbIndent & vbIndent & "call updateData(" & Chr(34) & Me.DataBaseTable2Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & vbIndent & "Response.Redirect " & Chr(34) & Me.admFinalConfirmFile & "?src=" & Chr(34) & " & SRC & " & Chr(34) & "&id=" & Chr(34) & " & ID ")
        str = str & vbCrLf & (vbIndent & "end if")
        str = str & vbCrLf & ("ElseIf request(" & Chr(34) & "btnCancel" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.admFinalConfirmFile & "?src=" & Chr(34) & " & SRC & " & Chr(34) & "&id=" & Chr(34) & " & ID ")
        str = str & vbCrLf & ("End if")
        str = str & vbCrLf & (("%" & ">"))
    ...
    Public Function generateAdmConfirmFinalFile() As String
        ...
        str = str & vbCrLf & (("call retrieveData(" & Chr(34) & Me.DataBaseTable2Name & Chr(34) & ", ID)"))
        str = str & vbCrLf & vbCrLf

        str = str & vbCrLf & ("if request(" & Chr(34) & "btnEdit" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")

        str = str & vbCrLf & ("'To edit")
        str = str & vbCrLf & ("Response.Redirect " & Chr(34) & Me.admFinalEditFile & "?src=" & Chr(34) & " & SRC & " & Chr(34) & "&id=" & Chr(34) & " & ID ")
        ...
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnYesApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & (vbIndent & "call approveData(" & Chr(34) & Me.DataBaseTable2Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.admListFile & Chr(34))
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnNoApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        ...
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnDisApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnYesDisApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & (vbIndent & "call disapproveData(" & Chr(34) & Me.DataBaseTable2Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.admListFile & Chr(34))
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnNoDisApprove" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        ...
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnDelete" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnYesDelete" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & (vbIndent & "call deleteData(" & Chr(34) & Me.DataBaseTable2Name & Chr(34) & ", ID)")
        str = str & vbCrLf & (vbIndent & "call clearSession()")
        str = str & vbCrLf & (vbIndent & "Response.Redirect " & Chr(34) & Me.admListFile & Chr(34))
        str = str & vbCrLf & ("elseif request(" & Chr(34) & "btnNoDelete" & Chr(34) & ") <> " & Chr(34) & Chr(34) & " then")
        str = str & vbCrLf & ("end if")
